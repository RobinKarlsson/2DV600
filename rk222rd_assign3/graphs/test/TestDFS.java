...
*/
package rk222rd_assign3.graphs.test;
...
import rk222rd_assign3.rk222rd.*;
...
public class TestDFS  {    
    ...
    public void testPostOrder() throws Exception {
    	...
    	System.out.println(dfs.dfs(dg, root1));
        System.out.println(dfs.postOrder(dg,root1));
    	assertEquals(list.size(),7);
    	int start = list.get(0).num;
    	for (int j=0;j<list.size();j++) {
    		Node<Integer> node =  list.get(j);
    ...
    public void testCyclic() throws Exception {
    	...
    	System.out.println(dfs.dfs(dg));
    	System.out.println(dfs.postOrder(dg));
    	assertTrue(dfs.isCyclic(dg));
